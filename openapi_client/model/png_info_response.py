...
class PNGInfoResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, info, items, *args, **kwargs):  # noqa: E501
        """PNGInfoResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, info, items, *args, **kwargs):  # noqa: E501
        """PNGInfoResponse - a model defined in OpenAPI
